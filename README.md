...
- **[spec-driven-dev](plugins/spec-driven-dev)** - Spec-driven development with structured directories, borrowing ideas from Kiro and Spec-kit.
...
- **[project-notes](plugins/project-notes)** - Project knowledge management with `notes/`, a structured decision log, and timestamped journal entries.
